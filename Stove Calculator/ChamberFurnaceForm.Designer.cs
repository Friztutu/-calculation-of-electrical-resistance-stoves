namespace Stove_Calculator
{
    partial class ChamberFurnaceForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel1.Controls.Add(cmbboxLiningFireproof);
            ...
            label5.Location = new Point(638, 183);
            label5.Name = "label5";
            ...
            // btnStopCalculations
            // 
            btnStopCalculations.FlatAppearance.BorderSize = 0;
            btnStopCalculations.FlatStyle = FlatStyle.Flat;
            btnStopCalculations.IconChar = FontAwesome.Sharp.IconChar.Stop;
            btnStopCalculations.IconColor = Color.White;
            btnStopCalculations.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnStopCalculations.Location = new Point(423, 324);
            btnStopCalculations.Name = "btnStopCalculations";
            btnStopCalculations.Size = new Size(228, 57);
            btnStopCalculations.TabIndex = 43;
            btnStopCalculations.Text = "Закончить расчёт";
            btnStopCalculations.TextImageRelation = TextImageRelation.ImageBeforeText;
            btnStopCalculations.UseVisualStyleBackColor = true;
            btnStopCalculations.Visible = false;
            // 
            // btnContinueCalculations
            // 
            btnContinueCalculations.FlatAppearance.BorderSize = 0;
            btnContinueCalculations.FlatStyle = FlatStyle.Flat;
            btnContinueCalculations.IconChar = FontAwesome.Sharp.IconChar.Play;
            btnContinueCalculations.IconColor = Color.White;
            btnContinueCalculations.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnContinueCalculations.Location = new Point(67, 324);
            btnContinueCalculations.Name = "btnContinueCalculations";
            btnContinueCalculations.Size = new Size(350, 57);
            btnContinueCalculations.TabIndex = 42;
            btnContinueCalculations.Text = "Перейти к расчёту перекрытия";
            ...
            label15.Location = new Point(189, 407);
            ...
            label12.Location = new Point(41, 281);
            ...
            cmbboxLiningInsulation.Location = new Point(391, 242);
            ...
            label8.Location = new Point(41, 245);
            label8.Name = "label8";
            ...
            label6.Location = new Point(41, 214);
            label6.Name = "label6";
            label6.Size = new Size(350, 22);
            label6.TabIndex = 32;
            label6.Text = "Температура на границе раздела слоев: ";
            ...
            lblLiningCalculationTitle.Location = new Point(267, 80);
            ...
            lblLiningCalculationTitle.Visible = false;
            // 
            // txtboxLiningFireproofWidth
            // 
            txtboxLiningFireproofWidth.ForeColor = Color.Black;
            txtboxLiningFireproofWidth.Location = new Point(391, 175);
            ...
            label4.TabIndex = 29;
            label4.Text = "Введите толщину слоя огнеупора:";
            ...
            cmbboxLiningFireproof.Location = new Point(391, 139);
